    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.h2 variants={variants} className="text-5xl md:text-6xl font-light text-slate-900 mb-6 tracking-tight">
            Reserve Your <span className="font-medium bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-violet-600">Private Session</span>
          </motion.h2>
          ...
          <motion.p variants={variants} className="text-xl text-slate-600/90 max-w-2xl mx-auto leading-relaxed font-light">
            Select from our curated availability for a personalized consultation experience.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-indigo-50/80 to-violet-50/80 px-10 py-8 border-b border-indigo-100/30">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-indigo-600/90 mt-2 font-light">Choose your preferred session type</p>
              </div>
          ...
          <div className="relative min-h-[750px] w-full" style={{ transform: 'translateZ(0)' }}>
            {isLoading ? (
              <div className="absolute inset-0 flex items-center justify-center bg-white/50 backdrop-blur-sm">
                ...
                >
                  ...
                  <p className="text-lg text-slate-500 font-medium mb-6">Preparing your booking experience...</p>
              ...
              >
                ...
                <div 
                  ...
                  ref={calendlyRef}
                  className="relative w-full h-[750px] overflow-hidden z-30"
                  style={{
          ...
          <div className="bg-gradient-to-r from-indigo-50/80 to-violet-50/80 px-10 py-8 border-t border-indigo-100/30" style={{ position: 'relative', zIndex: 20 }}>
            <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
              <div className="flex items-center space-x-5">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-700">End-to-End Encrypted</p>
                  <p className="text-xs text-slate-500/80 font-light">Your privacy is our priority</p>
                </div>
              </div>
              <motion.a 
                href="/contact"
