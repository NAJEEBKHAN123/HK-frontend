      ...
      <div className="max-w-7xl lg:px-[75px] w-full">
        ...
        <motion.div variants={container} className="text-center mb-16">
          ...
          <motion.p
            ...
            className="text-gray-400 max-w-4xl text-justify  px-2 mt-4 lg:text-lg mx-auto"
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 lg:pt-10 sm:grid-cols-2 lg:grid-cols-3 gap-9 p-1 lg:px-5 sm:px-1 "
        >
